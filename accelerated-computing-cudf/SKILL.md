...
- [jupyter-notebook](../jupyter-notebook/SKILL.md): Use it when the cuDF workflow also needs notebook-first experimentation or reproducible analysis.
- [development-workflow](../development-workflow/SKILL.md): Use it when the migration also needs a scoped implementation and validation plan.
- [documentation-verification](../documentation-verification/SKILL.md): Use it when the deliverable is a guide or README that must keep commands and caveats accurate.

...
All notable changes to the `codebase-design` skill are documented here.
...
- Clarified that the vocabulary must not rename required project or assignment identifiers.

### Fixed

- Preserved existing project naming contracts while importing the deep-module design vocabulary.

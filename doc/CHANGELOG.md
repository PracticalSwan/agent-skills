...
All notable changes to the `doc` skill are documented here.
...
## [2026-07-11] - Child-Path Import And Version 1.3 Normalization
...
- Deferred the optional `pdf2image` dependency check until after argument parsing so `render_docx.py --help` works in a minimal environment and actual renders return an actionable dependency error.

...
- Added stronger cross-references to documentation-authoring and documentation-patterns, plus a ready-to-copy agent prompt template.
...
### Changed
- Reworked the skill around explicit documentation-quality standards and review criteria

### Added
- `scripts/doc-style-audit.py` for lightweight Markdown quality checks

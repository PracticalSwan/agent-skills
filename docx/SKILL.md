...
- Codex: install or sync the folder into
  `$CODEX_HOME/skills/docx` and restart Codex after major changes.
...
- Activating `docx` outside its documented task boundary.
...
Before claiming the `docx` workflow succeeded:

...
All notable changes to the `ds-notebook-strict-code` skill are documented here.
...
- Narrowed activation to explicit code-cell-only requests or the originating ITX2007 assignment context so ordinary data-science tasks keep normal output.

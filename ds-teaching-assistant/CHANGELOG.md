...
All notable changes to the `ds-teaching-assistant` skill are documented here.
...
- Narrowed activation to explicit undergraduate teaching and assignment guidance instead of generic data or Python tasks.

...
All notable changes to the `figma-code-connect` skill are documented here.
...
- Imported the canonical `skills/figma-code-connect` workflow from `https://github.com/figma/mcp-server-guide` at commit `7f6562c4900fafb46e5e8fd3cc8ced954779bab3`.
...
- Replaced the literal Code Connect token example with an environment-backed secret handoff.

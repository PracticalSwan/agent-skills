...
- Imported the canonical `skills/figma-generate-library` workflow from `https://github.com/figma/mcp-server-guide` at commit `7f6562c4900fafb46e5e8fd3cc8ced954779bab3`.

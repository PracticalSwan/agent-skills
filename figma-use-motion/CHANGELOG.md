...
All notable changes to the `figma-use-motion` skill are documented here.
...
- Imported the canonical `skills/figma-use-motion` workflow from `https://github.com/figma/mcp-server-guide` at commit `7f6562c4900fafb46e5e8fd3cc8ced954779bab3`.

...
- Imported the canonical `skills/figma-use` workflow from `https://github.com/figma/mcp-server-guide` at commit `7f6562c4900fafb46e5e8fd3cc8ced954779bab3`.
...
- Corrected the nested working-with-design-systems link to the shared token-creation reference.

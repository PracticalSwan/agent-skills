...
All notable changes to the `gardening-skills-wiki` skill are documented here.
...
- Replaced broad recursive-deletion examples with an exact-path inspection and explicit-confirmation workflow.

...
All notable changes to the `hf-cloud-aws-context-discovery` skill are documented here.
...
- Imported the canonical `skills/hf-cloud-aws-context-discovery` workflow from `https://github.com/huggingface/skills` at commit `020194918dc4a27d5a5d9a154b6b56cc2bd21364`.

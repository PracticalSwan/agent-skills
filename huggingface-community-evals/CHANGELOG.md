...
All notable changes to the `huggingface-community-evals` skill are documented here.
...
- Imported the canonical `skills/huggingface-community-evals` workflow from `https://github.com/huggingface/skills` at commit `020194918dc4a27d5a5d9a154b6b56cc2bd21364`.
...
- Replaced the literal token example with an approved environment/secret-manager check.

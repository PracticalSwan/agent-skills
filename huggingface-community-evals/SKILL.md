...
- Codex: install or sync the folder into
  `$CODEX_HOME/skills/huggingface-community-evals` and restart Codex after major changes.
...
- Activating `huggingface-community-evals` outside its documented task boundary.
...
Before claiming the `huggingface-community-evals` workflow succeeded:

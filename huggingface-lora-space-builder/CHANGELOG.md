...
All notable changes to the `huggingface-lora-space-builder` skill are documented here.
...
- Imported the canonical `skills/huggingface-lora-space-builder` workflow from `https://github.com/huggingface/skills` at commit `020194918dc4a27d5a5d9a154b6b56cc2bd21364`.
...
- Replaced token-paste prompts with approved local-login or secret-manager handoffs.

...
All notable changes to the `huggingface-paper-publisher` skill are documented here.
...
- Imported the canonical `skills/huggingface-paper-publisher` workflow from `https://github.com/huggingface/skills` at commit `020194918dc4a27d5a5d9a154b6b56cc2bd21364`.
...
- Replaced literal-token troubleshooting commands with an approved environment check.

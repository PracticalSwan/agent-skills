...
All notable changes to the `huggingface-vision-trainer` skill are documented here.
...
- Imported the canonical `skills/huggingface-vision-trainer` workflow from `https://github.com/huggingface/skills` at commit `020194918dc4a27d5a5d9a154b6b56cc2bd21364`.
...
- Replaced notebook-relative Transformers links with stable official documentation URLs.
- Replaced literal Hub token examples with environment-backed authentication.

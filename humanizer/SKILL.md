...
tags: [humanizer, writing, prose, voice]
description: "Use the compact Humanizer workflow to rewrite AI-sounding prose in the writer's voice without changing supported facts; use avoid-ai-writing for detection, edit-in-place, or iterative catalog workflows."
license: "MIT"
---
...
- Codex: install or sync the folder into
  `$CODEX_HOME/skills/humanizer` and restart Codex after major changes.
...
- Fallback prompt: "Use the Humanizer: remove AI writing patterns skill without MCP. Rely on its local instructions, bundled resources, standard shell or editor tools, and direct verification. Show the evidence used before concluding."
...
- Activating `humanizer` outside its documented task boundary.
...
Before claiming the `humanizer` workflow succeeded:
...
- [avoid-ai-writing](../avoid-ai-writing/SKILL.md): Use it for detector, audit, edit-in-place, and iterate-to-convergence workflows.
- [voice-preserving-rewriter](../voice-preserving-rewriter/SKILL.md): Use it when preserving a specific writer voice is the primary constraint.

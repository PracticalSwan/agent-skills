...
All notable changes to the `mongodb-connection` skill are documented here.
...
- Imported the canonical `skills/mongodb-connection` workflow from `https://github.com/mongodb/agent-skills` at commit `b4ea8150a020b9babaddc6c271c6dc177c06a83f`.

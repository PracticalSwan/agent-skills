...
- Imported the canonical `skills/mongodb-search-and-ai` workflow from `https://github.com/mongodb/agent-skills` at commit `b4ea8150a020b9babaddc6c271c6dc177c06a83f`.

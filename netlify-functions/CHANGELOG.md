...
All notable changes to the `netlify-functions` skill are documented here.
...
- Imported the canonical `skills/netlify-functions` workflow from `https://github.com/netlify/context-and-tools` at commit `5a62a5694417640a2bba11a0701c8995ecc40bcc`.

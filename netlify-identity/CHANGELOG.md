...
All notable changes to the `netlify-identity` skill are documented here.
...
- Imported the canonical `skills/netlify-identity` workflow from `https://github.com/netlify/context-and-tools` at commit `5a62a5694417640a2bba11a0701c8995ecc40bcc`.

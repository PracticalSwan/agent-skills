...
All notable changes to the `netlify-image-cdn` skill are documented here.
...
- Imported the canonical `skills/netlify-image-cdn` workflow from `https://github.com/netlify/context-and-tools` at commit `5a62a5694417640a2bba11a0701c8995ecc40bcc`.

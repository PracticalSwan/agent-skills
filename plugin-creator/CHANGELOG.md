...
All notable changes to the `plugin-creator` skill are documented here.
...
- Clarified that this workflow creates Codex plugins even when another host
  authors the files, and that Claude Code plugins require Claude's native
  format.

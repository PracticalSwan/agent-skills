...
- Codex: install or sync the folder into
  `$CODEX_HOME/skills/pptx` and restart Codex after major changes.
...
- Activating `pptx` outside its documented task boundary.
...
Before claiming the `pptx` workflow succeeded:

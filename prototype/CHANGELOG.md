...
All notable changes to the `prototype` skill are documented here.
...
- Made branch preservation, commits, pushes, and cleanup explicitly authorization-gated.

### Fixed

- Prevented throwaway prototypes from implying automatic history or publication changes.

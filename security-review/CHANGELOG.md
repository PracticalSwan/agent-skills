...
- Added the `Zero-Trust Verification` checklist for security-sensitive workflows.
...
All notable changes to the `security-review` skill will be documented in this file.
...
### Added
- Imported this skill from `https://github.com/github/awesome-copilot` at `skills/security-review`.

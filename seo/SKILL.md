...
- Codex: install or sync the folder into
  `$CODEX_HOME/skills/seo` and restart Codex after major changes.
...
- Fallback prompt: "Use the SEO optimization skill without MCP. Rely on its local instructions, bundled resources, standard shell or editor tools, and direct verification. Show the evidence used before concluding."
...
- Activating `seo` outside its documented task boundary.
...
Before claiming the `seo` workflow succeeded:

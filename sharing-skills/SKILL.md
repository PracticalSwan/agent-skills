...
- Skill has been tested (see writing-skills for TDD process)
...
- Codex: install or sync the folder into
  `$CODEX_HOME/skills/sharing-skills` and restart Codex after major changes.
...
- Fallback prompt: "Use the Sharing Skills skill without MCP. Rely on its local instructions, bundled resources, standard shell or editor tools, and direct verification. Show the evidence used before concluding."
...
- Activating `sharing-skills` outside its documented task boundary.
...
Before claiming the `sharing-skills` workflow succeeded:

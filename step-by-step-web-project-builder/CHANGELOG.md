...
All notable changes to the `step-by-step-web-project-builder` skill are documented here.
...
- Replaced the host-specific `Artifact` instruction with a portable learning-plan step.

...
All notable changes to the `stitch-enhance-prompt` skill will be documented in this file.
...
- Refreshed support material from `https://github.com/google-labs-code/stitch-skills` at `plugins/stitch-utilities/skills/enhance-prompt` and commit `7b53207b94e62911777d53d4238b5f8c88c2b519`.
...
- Refreshed support material from `https://github.com/google-labs-code/stitch-skills` at `plugins/stitch-utilities/skills/enhance-prompt` and commit `3f64079d75d025bc5890c73669f27c26a2d80b31`.
...
- Imported support material from `https://github.com/google-labs-code/stitch-skills` at `plugins/stitch-utilities/skills/enhance-prompt`.

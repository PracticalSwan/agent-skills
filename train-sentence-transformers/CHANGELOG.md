...
All notable changes to the `train-sentence-transformers` skill are documented here.
...
- Imported the canonical `skills/train-sentence-transformers` workflow from `https://github.com/huggingface/skills` at commit `020194918dc4a27d5a5d9a154b6b56cc2bd21364`.

...
All notable changes to the `vercel-optimize` skill are documented here.
...
- Imported the canonical `skills/vercel-optimize` workflow from `https://github.com/vercel-labs/agent-skills` at commit `b8caa260a420a73042e35521de4b5c8baf6446cc`.

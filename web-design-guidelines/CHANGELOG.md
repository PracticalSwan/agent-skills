...
All notable changes to the `web-design-guidelines` skill are documented here.
...
- Imported the canonical `skills/web-design-guidelines` workflow from `https://github.com/vercel-labs/agent-skills` at commit `b8caa260a420a73042e35521de4b5c8baf6446cc`.

...
All notable changes to the `web-dev-explainer` skill are documented here.
...
- Replaced the assumed `code_execution` wrapper with host-available execution tooling.

...
All notable changes to the `writing-for-agents` skill are documented here.
...
- Preserved the source skill's progressive-disclosure guidance inside the shared catalog schema.

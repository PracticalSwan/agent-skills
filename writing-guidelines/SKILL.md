...
- Codex: install or sync the folder into
  `$CODEX_HOME/skills/writing-guidelines` and restart Codex after major changes.
...
- Fallback prompt: "Use the Writing Guidelines skill without MCP. Rely on its local instructions, bundled resources, standard shell or editor tools, and direct verification. Show the evidence used before concluding."
...
- Activating `writing-guidelines` outside its documented task boundary.
...
Before claiming the `writing-guidelines` workflow succeeded:
